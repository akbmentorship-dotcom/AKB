          ...
          {WORKOUT_OPTIONS.map((opt, i) => (
            <button
              ...
              style={{
                ...
                padding: '12px 16px',
                background: opt.id === dayType ? 'var(--orange-dim)' : 'none',
                border: 'none',
                borderBottom: i < WORKOUT_OPTIONS.length - 1 ? '1px solid var(--border)' : 'none',
                cursor: 'pointer', textAlign: 'left',
                color: opt.id === dayType ? 'var(--orange)' : 'var(--white)',
              }}
            >
              ...
              {opt.id === dayType && <span style={{ marginLeft: 'auto', fontSize: 12 }}>✓</span>}
            </button>
          ))}
        </div>
      )}
